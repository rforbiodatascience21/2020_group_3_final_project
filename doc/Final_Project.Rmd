...
knitr::include_graphics("/cloud/project/doc/images/rawdata.png")
```
...
## Materials and Methods
```{r, echo=FALSE, out.width = '100%'}
knitr::include_graphics("/cloud/project/doc/images/Project_flow_chart.png")
```
...
knitr::include_graphics("/cloud/project/doc/images/shiny.png")
```

https://hcehlers.shinyapps.io/DiaPredict/
